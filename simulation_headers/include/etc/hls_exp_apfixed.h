...
ap_fixed<W_,I_> exp10(ap_fixed<W_,I_> x) {
	...
	ap_fixed<W_,I_> r;
	if(I_s_==0) { //I_s_ = 0, M_ = 1, I_ <= 2, F_ <= 1, W <= 3
		ap_fixed<3,2> x_l = x;
		ap_ufixed<2,1> y = 0;
		if(x_l[2]) {
			if(x_l[1]&&x_l[0]) {
		...
		r = y;
	} else if (I_s_==1) {// I_s_ = 1, M_ = 2..3, I_ <= 4, F_ <= 3, W <= 7
		ap_fixed<7,4> x_l = x;
		ap_ufixed<6,3> y = 0;
		...
		r = y;
	} else if (I_s_==2) {// I_s_ = 2, M_ = 4..6, I_ <= 7, F_ <= 6, W <= 13
		ap_fixed<13,7> x_l = x;
		ap_ufixed<12,6> y = 0;
		ap_fixed<2,2> x_l_int;
		x_l_int(1,0) = x_l(7,6);
		...
		r = y;
	} else if (I_s_==3) {// I_s_ = 3, M_ = 7..13, I_ <= 14, F_ <= 13, W <= 27
		...
		r = y;
	} else if (I_s_==4) {// I_s_ = 4, M_ = 14..26, I_ <= 27, F_ <= 26, W <= 53
		...
		r = y;
	} else {// I_s_ = 5, M_ = 27..32, I_ <= 33, F_ <= 32, W <= 65
		ap_fixed<65,33> x_l = x;
		ap_ufixed<64,32> y = 0;
		ap_fixed<5,5> x_l_int;
