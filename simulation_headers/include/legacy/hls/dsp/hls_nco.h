...
#error One or more of the template parameters used by this function is already defined and will cause a conflict
  ...
  public:
      ...
      nco(const ap_uint<AccumWidth> InitPinc,
        ...
        create_lut(sinLut);
        //move initial code to sub function
        init(InitPinc,InitPoff);
      }; // end constructor
  ...
  private:
      ...
      void init(const ap_uint<AccumWidth> InitPinc,
                const ap_uint<AccumWidth> InitPoff) {
        phaseAcc = 0;
        pincReg = 0;
        newPinc = InitPinc;
      ...
      void nco_ssr(stream< ap_uint<AccumWidth> > &pinc,
        ...
        // move ARRAY_PARTITION sinPhiPre and cosPhiPre to constructor
