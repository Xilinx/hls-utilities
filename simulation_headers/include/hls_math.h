...
#include "etc/hls_pow_apfixed.h"
#include "etc/hls_diff_apfixed.h"
#include "etc/hls_comparison_apfixed.h"
#include "etc/hls_frexp_apfixed.h"
#include "etc/hls_modf_apfixed.h"
#include "etc/hls_isequal_isnotequal_apfixed.h"
#include "etc/hls_all_any_apfixed.h"
#include "etc/hls_select_bitselect_apfixed.h"
#include "etc/hls_erf_apfixed.h"
#include "etc/hls_fmod_rem_quo_remainder_divide_apfixed.h"
#include "etc/hls_lgamma_apfixed.h"
#include "etc/hls_tgamma_apfixed.h"
#include "etc/hls_fract_apfixed.h"
#include "etc/hls_mad_apfixed.h"
#include "etc/hls_cbrt_apfixed.h"
#include "etc/hls_hypot_apfixed.h"
#include "etc/hls_ldexp_apfixed.h"
